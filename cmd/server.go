...
func init() {
	cmd.Register(&cli.Cmd{
		...
		Flags: []cli.Flag{
			...
			&cli.BoolFlag{
				Name:  "secure",
				Usage: "Use TLS with the --cert and --key flags",
				Value: false,
			},
			&cli.StringFlag{
				Name:  "cert",
